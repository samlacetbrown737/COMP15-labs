...
# 
#
partyPlaylist: CircularBuffer.o Stack.o Queue.o main.o
	${CXX} ${LDFLAGS} -o partyPlaylist CircularBuffer.o Stack.o \
                                       Queue.o main.o
...
#
provide:
	provide comp15 lab3 CircularBuffer.cpp CircularBuffer.h \
			Queue.cpp Queue.h           \
			Stack.cpp Stack.h Makefile
