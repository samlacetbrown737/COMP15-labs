...
/* TASKS: STUDENT TO DO
 *    - first, define things that ALL recursive functions must have
 1. base case
 2. recursive step
 3. step moves towards solution
 *    - for the first 3 functions, find something wrong with the
 *      recursive function. Then fix them.
...
* where the n'th number can be computed by taking the sum of the two
...
// Example:
//     printReverse() called, and string is midterm. desired output: mretdim
void printReverse() {
...
void printReverse(string word) {
    ...
    cout << word[0]; // Do not change the part of this line that says " word[0]"
